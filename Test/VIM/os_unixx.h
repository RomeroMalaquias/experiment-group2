...
char* alloc(int value) {
    return "alloc";
}
int mch_getperm(char* buf) {
    return -1;
}

int mch_has_exp_wildcard(char* value) {
    return 0;
}
...
int vim_regexec(int value, char * value2, int value3) {
   return 1;
}

int vim_free(int value) {
   return 1;
}

int file_pat_to_reg_pat(int value1, int value2, int value3, int value4) {
    return -1;
}

int rem_backslash(int value) {
    return 1;
}

int vim_strchr(char* value1, int value2) {
    return 0;
}
